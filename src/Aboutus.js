        ...
        <div className="container mb-5">
          <div className="row">
            <div className="col-lg-5  col-12 text-center service-left">
              <img src="https://i.ibb.co/T05LnM4/hero3.jpg" alt="about us" />
            </div>
            <div className="col-lg-7 col-12 service-right">
              <h3 className="service-title">~Available in IOS & android</h3>
              <h1 className="main-heading">How to use the App?</h1>
              {aboutData.map((ele, ind) => {
                return (
                  <>
                    <div className="row service-info" key={ele.id}>
                      <div className="col-1 service-no">{ele.id}</div>
        ...
        <div className="container mb-5 services-2">
          <div className="row">
            <div className="col-lg-7 col-12 service-right d-flex justify align-items-start flex-column">
              <h3 className="service-title">~Support in any Language</h3>
